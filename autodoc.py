...
# Example CSV content
example_csv = """grantee_name,grant_number,grantee_street,grantee_citystatezip,award_amount_numerical,convert_numbers_to_words,contact_name,contact_title,contact_number,contact_email,sig_name,sig_title
...
if st.button("Generate Documents") and template_document and data and unique_name:
  zip_buffer = BytesIO()
  ...
  with zipfile.ZipFile(zip_buffer, 'w') as zipf:
      for row in data:
          ...
          zipf.writestr(file_name, doc_buffer.getvalue())
